...
if(isset($_POST["submit"])){
    ...
    $query = "INSERT into bagian(nama_bagian, karyawan_id, lokasi_id)  VALUES (:nama_bagian, :karyawan_id , :lokasi_id)";
                                  ...
                                  <form action="" method="post">
                                      <div class="card-body">
                                          <div class="form-group">
                                              ...
                                              <input  type="text" class="form-control" id="nama" name="nama_bagian" placeholder="Nama bagian" required>
                                          </div>
                                          <div class="form-group">
