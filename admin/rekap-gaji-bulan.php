        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Data Gaji Perbulan Tahun <?= $tahun ?> </h1>
                        </div>
                        <div class="col-sm-6">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="rekap-gaji-karyawan.php?bulan=<?= $row['bulan']; ?>&tahun=<?= $tahun; ?>" class="btn btn-info btn-xs text-light"><i class="fa fa-eye"></i> Perkaryawan</a>
                                                    </td>
                                                    <td><?= $row["bulan"]; ?></td>
