...
if(isset($_POST["submit"])){
  ...
  $query = "INSERT into jabatan(nama_jabatan, gapok_jabatan ,tunjangan_jabatan, uang_makan_perhari) VALUES (
    :name, :gapok, :tunjangan, :uang_makan)";
                                ...
                                <form action="" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="nama" name="nama_jabatan" placeholder="Nama Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Gapok Jabatan:</label>
                                            <input type="text" class="form-control" id="nama" name="gapok" placeholder="Gaji Pokok Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Tunjangan Jabatan:</label>
                                            <input type="text" class="form-control" id="nama" name="tunjangan" placeholder="Tunjangan Jabatan" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="nama">Uang Makan Perhari:</label>
                                            <input type="text" class="form-control" id="nama" name="uang_makan" placeholder="Uang Makan Perhari" required>
                                        </div>
                                        <!-- <div class="form-group">
